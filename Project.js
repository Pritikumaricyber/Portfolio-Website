  ...
  const projects = [
    {
      ...
      description: "A system to manage and track stock inventory efficiently.",
      link: "https://example.com",
      technologies: ["C++", "FileHandling", "HTML", "CSS"],
    },
    {
      id: 2,
      title: "Study Tracker",
      description: "A simple tracker using python.",
      link: "https://example.com",
      technologies: ["Python", "LocalStorage", "HTML", "CSS"],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        "A full-stack blood management system with user authentication.",
      link: "https://example.com",
